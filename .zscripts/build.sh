...
# Do NOT copy database to build artifacts - use persistent absolute path instead
# This prevents data loss on redeployment. The production .env will be set to
# use DATABASE_URL=file:/home/z/my-project/db/custom.db (absolute path)
echo "🗄️  Using persistent database path (not bundling DB in build artifacts)"
echo "   Production will use DATABASE_URL from environment or .env"
